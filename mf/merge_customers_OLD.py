# Script for cleaning and merging customer data from Listrak, Shopify, Friendbuy, Bazaarvoice, and Registrations
# This is the original script used to merge and update customers with data across all different sources
...
friendbuy = pd.read_csv('friendbuy.csv')
bazaar = pd.read_csv('reviews_clean.csv')
...
listrak_sources = ['Popup','NewPopup','ExitPopup','NewExitPopup','Account','Checkout','GuestCheckout','Facebook','FacebookLeadAd','NewFacebookLeadAd','Footer','MiniForm','PreferenceCenter','Sweepstakes','SMS','ContactUs','Parentlink','Registration Form','Friendbuy']
...
customers.to_csv("customers_clean_no_emails.csv")
bar.finish()  
